...
// Package config implements the marshalling/unmarshalling configuration files.
package config
...
// See github.com/pushrax/chihaya/database/Database.startFlushing() for more info.
